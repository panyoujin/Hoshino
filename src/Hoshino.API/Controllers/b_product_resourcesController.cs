...
namespace Hoshino.API.Controllers
{
    ...
    public class b_product_resourcesController : ControllerBase
    {
        ...
        [HttpDelete]
        [ProducesResponseType(200, Type = typeof(ApiResult<bool>))]
        public ActionResult<object> Delete([FromBody]b_product_resources_Entity model)
        {
        ...
        {
            b_product_resources_Entity model = new b_product_resources_Entity();
            model.P_Resources_ID = P_Resources_ID;
